      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-gray-600 text-lg max-w-2xl mx-auto">
            A professional toolkit of technologies and frameworks I use to build
            scalable, modern, and user-focused applications.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {skills.map((s, i) => {
            const Icon =
              LucideIcons[s.icon] || LucideIcons["Code2"];
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                className="
                  relative group p-6 rounded-2xl bg-white border border-gray-100
                  shadow-lg hover:shadow-2xl hover:-translate-y-2
                  transition-all duration-300 overflow-hidden
                "
              >
                {/* Glow Effect */}
                <div className="absolute inset-0 opacity-0 group-hover:opacity-25 bg-gradient-to-r from-indigo-500 to-purple-500 blur-xl transition"></div>
